...
public class CopyFilesStxtToTxt extends AbstractDirProcessor
{
    // --------------------------
    ...
    {
    	String dstName = srcFile.getCanonicalPath().substring(lengthBaseDir);
    	
    	if (dstName.endsWith(".stxt"))
    		dstName = dstName + ".txt";
    	
        File dstFile = new File(todir, dstName);
